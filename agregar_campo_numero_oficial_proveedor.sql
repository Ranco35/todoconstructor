...
-- 5. ACTUALIZAR facturas existentes (opcional)
-- Si tienes facturas donde el número actual ES el oficial del proveedor:
/*
UPDATE purchase_invoices 
SET supplier_invoice_number = number 
WHERE supplier_invoice_number IS NULL 
  AND number NOT LIKE 'FC%'; -- Solo si no es generado automáticamente
*/
