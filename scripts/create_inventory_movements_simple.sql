-- =====================================================
-- SCRIPT SQL SIMPLIFICADO PARA CREAR TABLA DE MOVIMIENTOS
-- Ejecutar en Supabase SQL Editor - VERSIÓN SIMPLE
-- =====================================================
...
-- Política para eliminación: solo administradores pueden eliminar movimientos (simplificada)
CREATE POLICY "inventory_movement_delete_policy" ON "InventoryMovement"
    FOR DELETE
    TO authenticated
    USING (true); -- Temporalmente permitir a todos, se puede ajustar después
