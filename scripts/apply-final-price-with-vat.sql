-- ═══════════════════════════════════════════════════════════════
-- SCRIPT: APLICAR PRECIO FINAL CON IVA EN RESERVAS
-- ═══════════════════════════════════════════════════════════════
...
-- FUNCIÓN MEJORADA: PRECIO FINAL CON IVA INCLUIDO
...
-- ═══════════════════════════════════════════════════════════════
-- VERIFICACIÓN: PRUEBA DE LA FUNCIÓN ACTUALIZADA
-- ═══════════════════════════════════════════════════════════════

-- Ejecutar esta consulta para probar que la función funciona correctamente
...
1. ✅ PRECIO FINAL CON IVA: 
   - Para productos vinculados: saleprice * (1 + vat/100)
   - Para productos modulares: price * 1.19 (asume IVA 19%)

2. ✅ BREAKDOWN MEJORADO:
   - Agregado campo 'unit_price_with_vat' en el desglose
   - Campo 'vat_included': true
   - Nota explicativa en el resultado

3. ✅ COMPATIBILIDAD:
   - Mantiene compatibilidad con la estructura existente
   - Solo cambia el cálculo de precios, no la interfaz

4. ✅ PRODUCTOS ADICIONALES:
   - También usa precio final con IVA incluido
   - Misma lógica para productos del paquete y adicionales

RESULTADO:
- Todas las reservas mostrarán precios finales con IVA incluido
- No se calculará IVA adicional en la interfaz
- Precios transparentes para el cliente
*/ 