-- ================================================
-- SOLUCIÓN FINAL PARA RESERVAS MODULARES
-- ================================================
...
-- 6. Crear habitaciones adicionales si no existen (CORREGIDO: usar estructura real)
INSERT INTO rooms (number, type, capacity, floor, price_per_night) VALUES
('suite_junior', 'Suite Junior', 2, 1, 60000),
('habitacion_estandar', 'Habitación Estándar', 2, 2, 50000),
('suite_matrimonial', 'Suite Matrimonial', 2, 3, 70000)
...
SELECT number as info, CONCAT(type, ' - $', price_per_night::text) as detalle FROM rooms;
...
SELECT '✅ SETUP COMPLETO - RESERVAS MODULARES LISTAS' as info, 'Ahora puedes crear reservas' as detalle; 