...
interface AllProductsPaginatedProps {
  products: ProductWithPromotion[]
  itemsPerPage?: number
}

export default function AllProductsPaginated({ 
  products,
  itemsPerPage = 20 
}: AllProductsPaginatedProps) {
  ...
  const productsWithoutStock = products.filter(p => p.stock === 0).length
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <span className="text-orange-600 font-medium">
              ⚠️ {productsWithoutStock} sin stock
            </span>
          </div>
          <div className="text-sm text-gray-600">
