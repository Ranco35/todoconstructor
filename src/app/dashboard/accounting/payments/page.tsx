...
import ConsolidatedPaymentsClient from './ConsolidatedPaymentsClient';

// Marcar como página dinámica para evitar errores en build
export const dynamic = 'force-dynamic';

export default async function ConsolidatedPaymentsPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Solo administradores y super usuarios pueden acceder a los pagos consolidados.</p>
  ...
  return <ConsolidatedPaymentsClient currentUser={currentUser} />;
} 