...
export default async function FinancialReportsPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Solo administradores y super usuarios pueden acceder a los reportes financieros.</p>
  ...
  return <FinancialReportsClient currentUser={currentUser} />;
} 