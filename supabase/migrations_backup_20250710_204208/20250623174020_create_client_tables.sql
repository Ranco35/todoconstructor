-- Migración para crear tablas de clientes
-- Esta migración crea todas las tablas necesarias para el módulo de clientes
...
-- Crear políticas RLS básicas (permitir todo para el service role)
CREATE POLICY "Enable all for service role" ON "Country" FOR ALL USING (true);
CREATE POLICY "Enable all for service role" ON "EconomicSector" FOR ALL USING (true);
CREATE POLICY "Enable all for service role" ON "RelationshipType" FOR ALL USING (true);
CREATE POLICY "Enable all for service role" ON "Client" FOR ALL USING (true);
CREATE POLICY "Enable all for service role" ON "ClientContact" FOR ALL USING (true);
CREATE POLICY "Enable all for service role" ON "ClientTag" FOR ALL USING (true);
CREATE POLICY "Enable all for service role" ON "ClientTagAssignment" FOR ALL USING (true);
