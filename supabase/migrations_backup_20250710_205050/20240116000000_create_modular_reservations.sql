...
CREATE INDEX idx_modular_reservations_reservation_id ON modular_reservations(reservation_id);
CREATE INDEX idx_modular_reservations_client_id ON modular_reservations(client_id);
CREATE INDEX idx_modular_reservations_package_modular_id ON modular_reservations(package_modular_id);
CREATE INDEX idx_modular_reservations_status ON modular_reservations(status);
CREATE INDEX idx_modular_reservations_created_at ON modular_reservations(created_at);
